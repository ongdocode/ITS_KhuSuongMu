...
# Lớp ChannelAttention giúp chú ý đến kênh thông tin quan trọng hơn của ảnh, cải thiện khả năng trích xuất đặc trưng.
...
# Lớp SpatialAttention giúp chú ý đến các vùng không gian quan trọng trong ảnh, cải thiện độ chính xác của mô hình.
...
# Mô hình chính HTDNet, kết hợp các cơ chế chú ý và trích xuất đặc trưng của ảnh.
...
# Lớp T_Attention kết hợp chú ý kênh (Channel Attention) và chú ý không gian (Spatial Attention)
...
# Lớp TIDFE (Trích xuất đặc trưng và giảm chiều ảnh)
...
# Lớp I_Net giúp trích xuất các đặc trưng của ảnh với các lớp tích chập khác nhau
...
# Lớp F_Net giúp trích xuất đặc trưng khác từ ảnh với các lớp tích chập khác nhau
...
# Lớp Discriminator là bộ phân biệt, sử dụng trong GAN để phân biệt ảnh thật và ảnh giả
